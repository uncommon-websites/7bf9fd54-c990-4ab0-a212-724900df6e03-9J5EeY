	...
	const features: Feature[] = [
		{
			...
			description:
				'Simply perform a task on screen. Squint’s visual recognition technology documents every critical step, click, and action without interrupting your workflow.',
		...
		},
		{
			...
			imageUrl: 'https://www.ledr.com/colours/white.jpg',
			imageAlt: 'A team member accessing an instruction guide on a tablet on the factory floor.',
			layout: 'reversed'
		}
	];
...
<section class="bg-gray-950 py-24 lg:py-32 {className}">
	<div class="mx-auto w-full max-w-[1728px] px-6 lg:px-8">
		<div class="grid grid-cols-12 gap-4 lg:gap-5">
			<div class="col-span-12 text-center">
				<div class="flex flex-col items-center">
					<div class="flex flex-col items-center gap-4 text-center">
						<h3 class="font-display text-balance text-4xl font-medium text-gray-200 sm:text-5xl">
				...
				<div class="col-span-12 lg:col-span-10 lg:col-start-2">
					<div class="flex flex-col gap-16 md:gap-24">
						{#each features as feature}
							<article
								class="flex w-full flex-col {feature.layout === 'reversed' ? 'md:flex-row-reverse' : 'md:flex-row'}"
							>
								<div
									class="relative aspect-square w-full overflow-hidden rounded-t-lg bg-gray-800 md:flex-1 {feature.layout === 'reversed' ? 'md:rounded-r-lg md:rounded-tl-none' : 'md:rounded-l-lg md:rounded-tr-none'}"
								>
									<img
								...
								<div
									class="flex w-full flex-col items-center justify-center rounded-b-lg bg-gray-900 md:aspect-square md:flex-1 {feature.layout === 'reversed' ? 'md:rounded-br-none md:rounded-l-lg' : 'md:rounded-bl-none md:rounded-r-lg'}"
								>
									<div class="flex w-full flex-col gap-5 p-8 md:px-24">
										<span class="font-body text-xl font-normal capitalize text-gray-100"
											>{feature.step}</span
										>
										<div class="flex flex-col gap-5">
											...
											<a
												...
												class="group flex w-max items-center font-body font-medium text-gray-400 transition-colors duration-300 ease-out hover:text-gray-50"
											>
