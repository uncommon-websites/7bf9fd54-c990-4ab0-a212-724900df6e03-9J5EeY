...
<section
  id="hero"
  class="flex flex-col items-center justify-center gap-6 bg-white pt-24 lg:pt-32 {className}"
>
  <div class="flex w-full flex-col items-center pt-6">
    <div class="flex flex-col items-center gap-8">
      <div class="flex flex-col items-center gap-6 px-6 text-center">
        <div>
          <h1
            class="font-display text-primary-950 text-balance text-6xl font-medium md:text-7xl lg:text-8xl"
          >
            Visual Knowledge.
          </h1>
          <h1
        ...
        <p
          class="font-body text-primary-800 mx-auto max-w-xl text-balance text-lg font-normal"
        >
          Squint automatically creates step-by-step guides from screen
          recordings, preserving your team's tribal knowledge before it walks
          out the door.
        </p>
      </div>
      <a
        class="bg-primary-950 text-primary-50 hover:bg-primary-200 active:bg-primary-300 flex h-12 cursor-pointer items-center justify-center rounded-md px-5 text-base font-medium transition-colors duration-300 ease-in-out"
        href="#"
      >
            ...
            >
              {#if !isPlaying}
                ...
                >
                  ...
                  >
                    <div
                      class="bg-primary-800/50 group-hover/videotrigger:bg-primary-800/60 flex h-14 w-14 items-center overflow-hidden rounded-full transition-all duration-500 ease-in-out md:h-[72px] md:w-[72px]"
                    >
                      <div
                      ...
                      >
                        ...
                        >
                          <svg
                            class="text-primary-950 h-6 w-6"
                            viewBox="0 0 24 24"
                            fill="currentColor"
                  ...
                  <div class="absolute inset-0 z-10 bg-black">
                    <img
                      alt="Manufacturing worker using tablet to access visual work instructions on the factory floor"
                      src="/generated/image-a-manufacturing-worker-standing-on-a-fac.webp"
